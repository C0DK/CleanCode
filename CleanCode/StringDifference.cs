...
public class StringDifference
{
    ...
    public bool AreEqual => Expected == Actual;

    private string GetCommonPrefix(int length) => Expected![..length];

    private string GetCommonSuffix(int length) => Expected!.Substring(Expected!.Length - length, length);
